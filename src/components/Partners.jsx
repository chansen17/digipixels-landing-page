...
import { FaBehance, FaDribbble, FaInstagram, FaDropbox, FaGoogle, FaLinkedin, Fa500Px, FaFacebook, FaTwitch} from 'react-icons/fa';

const Partners = () => {
    return (
        <div className='h-full w-full py-24 md:py-32'>
            <div className="mxw-lg">
                ...
                <section className="py-12 border-t border-t-zinc-800 border-b border-b-zinc-800 mt-10">
                    <div className="">
                            ...
                            <div className='w-full lg:w-1/2'>
                                <div className='w-full border-4 border-cyan-500 hover:scale-105 duration-300 transition-all h-auto rounded-xl bg-gradient-to-br from-rose-400 via-violet-500 to-cyan-500  py-8 px-5 relative shadow-2xl shadow-rose-400/20 space-y-3 text-gray-100'>
                                    ...
                                    <div className="w-full flex items-center justify-between gap-4">
                                        ...
                                        <button className="w-8 h-8 md:h-10 md:w-10 lg:h-14 lg:w-14 shrink-0 rounded-xl bg-gray-50 grid place-items-center">
                ...
                <p className='text-gray-200 pt-10'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Maiores, quo cumque. Qui a consequatur, cupiditate temporibus atque beatae autem corporis!</p>
            </div>
        </div>
    );
}
