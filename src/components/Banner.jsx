...
const Banner = () => {
    ...
    return (
        <Marquee className='w-full h-full py-5 md:py-8 bg-purple-600 overflow-x-clip overflow-y-hidden' gradient={true} gradientColor={[147, 51, 234, .05]} pauseOnHover={false} speed={50} loop={0}>
            {options.map(o => (
